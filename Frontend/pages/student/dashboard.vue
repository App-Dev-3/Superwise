    ...
    <div class="min-h-screen flex flex-col max-w-7xl w-full">
      ...
      >
        <ActionCard
            ...
            :button-text="
						t(
							'dashboard.student.startMatching',
						)
					"
            card-type="primary"
        ...
        >
          ...
          >
            <h2 class="text-xl mx-4 py-8">
              {{
                t(
                    'dashboard.student.findSupervisor',
                )
              }}
            </h2>
            <CardStack :amount="3">
      ...
      >
        <ActionCard
            ...
            :header-text="
						t(
							'dashboard.student.yourRequests',
						)
					"
            card-type="ghost"
            @action-button-clicked="
      ...
      >
        ...
        <ActionCard
            :button-text="
						t(
							'dashboard.student.downloadConfirmation',
						)
					"
            card-type="primary"
            @action-button-clicked="
        ...
        >
          <div class="h-96 flex">
            <div
                class="flex flex-col w-full items-center justify-center p-3"
            >
              <Avatar
                  :first-name="
									acceptedSupervisionRequests[0]
              ...
              />
              <h2
                  class="text-xl mx-4 py-8 text-center"
              >
                {{
                  acceptedSupervisionRequests[0]
                      .supervisor
...
const pendingSupervisionRequests =
    studentStore.pendingSupervisionRequests;
const acceptedSupervisionRequests =
    studentStore.acceptedSupervisionRequests;
...
const warning = computed(() => {
  if (acceptedSupervisionRequests.length > 1) {
    const namesOfAcceptedSupervisors =
        acceptedSupervisionRequests.map(
            (request) =>
    ...
    return t('dashboard.student.multipleAcceptedWarning', {
      ...
      supervisors:
          namesOfAcceptedSupervisors.join(', '),
    });
  }
  return '';
});
  ...
  setTimeout(() => {
    if (acceptedSupervisionRequests.length > 1) {
      ...
      if (modal) {
        ...
        console.error(
            'Warning modal element not found:',
            warningModalId.value,
        );
      }
    }
